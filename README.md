# Tailwind CSS + TypeScript + Next.js Starter + MUI
...
## <u>Etienne Spécifique :</u>

J'ai remis à jour les version les plus récentes de React, Node et Tailwind.

J'ai également ajouté MUI à l'ensemble.
